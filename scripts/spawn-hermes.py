...
def _build_project_config(slug: str, group_jid: str, env: dict, workspace: str = "") -> dict:
    ...
    prompt = (
        ...
        f"- Sapaan default: 'aku/kamu' atau nama — JANGAN 'gue/lu'/slang jalanan kecuali owner minta ganti gaya. "
        f"Santai tapi profesional & berkelas, bukan bahasa gaul.\n\n"
...
def create_hermes_data_dir(slug: str, port: int, group_jid: str, env: dict) -> Path:
    ...
    (data_dir / "SOUL.md").write_text(
        ...
        f"- **Sapaan (default):** pakai **'aku/kamu'** atau nama (mis. 'Eksa'). JANGAN pakai 'gue/lu' atau "
        f"slang jalanan — kecuali owner secara eksplisit minta ganti gaya. Santai-sopan, bukan bahasa gaul.\n"
